...
class PromoteSelectedTabOauthTest extends TestCase
{
    ...
    public function test_promote_selected_tab_oauth()
    {
        ...
        $data = [
            'profile' => 1,
            'fields' => json_encode(['trade_name' => 'promote']),
            'docID' => $id,
        ];

        $response = $this->dashboardService->promoteSelectedTabOauth($data);
